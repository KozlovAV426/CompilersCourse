...
/**
 ** \file /home/anatoly/complier/CompilersCourse/02-parsers/parser.hh
...
#ifndef YY_YY_HOME_ANATOLY_COMPLIER_COMPILERSCOURSE_02_PARSERS_PARSER_HH_INCLUDED
# define YY_YY_HOME_ANATOLY_COMPLIER_COMPILERSCOURSE_02_PARSERS_PARSER_HH_INCLUDED
...
#line 54 "/home/anatoly/complier/CompilersCourse/02-parsers/parser.hh"
...
namespace yy {
#line 188 "/home/anatoly/complier/CompilersCourse/02-parsers/parser.hh"
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_END || tok == token::TOK_ASSIGN || tok == token::TOK_MINUS || tok == token::TOK_PLUS || tok == token::TOK_STAR || tok == token::TOK_SLASH || tok == token::TOK_LPAREN || tok == token::TOK_RPAREN || tok == token::TOK_ISEQUAL || tok == token::TOK_AND || tok == token::TOK_OR || tok == token::TOK_MODULO || tok == token::TOK_LESS || tok == token::TOK_GREATER || tok == token::TOK_SEMICOLON || tok == token::TOK_TYPEINT || tok == token::TOK_ASSERT || tok == token::TOK_SOPRINTLN || tok == token::TOK_CLBRACKET || tok == token::TOK_CRBRACKET || tok == token::TOK_SLBRACKET || tok == token::TOK_SRBRACKET || tok == token::TOK_CLASS || tok == token::TOK_PUBLIC || tok == token::TOK_STATIC || tok == token::TOK_VOID || tok == token::TOK_MAIN || tok == token::TOK_NEW || tok == token::TOK_DOT || tok == token::TOK_LENGTH || tok == 289);
      }
#else
...
#line 1723 "/home/anatoly/complier/CompilersCourse/02-parsers/parser.hh"





#endif // !YY_YY_HOME_ANATOLY_COMPLIER_COMPILERSCOURSE_02_PARSERS_PARSER_HH_INCLUDED
